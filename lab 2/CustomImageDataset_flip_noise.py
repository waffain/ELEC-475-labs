...
class CustomImageDataset_flip_noise(Dataset):
...
# Reality check dataset
# image_set = CustomImageDataset_flip_noise("train_noses.txt", "./images", transforms.Compose([transforms.Resize((227, 227))]), None)
# print(f"Dataset size: {len(image_set)}")
#
