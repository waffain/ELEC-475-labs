...
class CustomImageDataset_rotate(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if aug_type == 1:  # rotate image by 15 degrees
...
# # Reality check dataset
# image_set = CustomImageDataset_rotate("train_noses.txt", "./images", transforms.Compose([transforms.Resize((227, 227))]), None)
# print(f"Dataset size: {len(image_set)}")
#
